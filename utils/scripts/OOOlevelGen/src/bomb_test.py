...
lb = LevelBuilder.LevelBuilder("level_1.plist")

lb.addObject(Hero.HeroSprite(x=20,y=10))
lb.addObject(Star.StarSprite(x=460,y=100,width=32,height=32))

lb.addObject(Beam.BeamSprite(x=100,y=25,width=100,height=30,static='false',angle=90,density=1))
lb.addObject(Beam.BeamSprite(x=290,y=25,width=250,height=30,static='false',angle=90,density=1))
lb.addObject(Bomb.BombSprite(x=240,y=200,width=50,height=50,static='true'))
