...
def render(name,bg):
    ...
    lb.addObject(Star.StarSprite(x=240,y=150,width=32,height=32))
    ...
    lb.addObject(Beam.BeamSprite(x=240,y=200,width=350,height=30,static='true',angle=0).setName("platform"))
