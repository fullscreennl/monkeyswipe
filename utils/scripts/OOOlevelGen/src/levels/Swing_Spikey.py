...
def render(name,bg):
    ...
    lb.addObject(Nut.NutSprite(x=240,y=310))
    
    lb.addObject(SpikeyBuddy.SpikeyBuddySprite(x=240,y=200,width=40,height=40,density=10))
    ...
    lb.addObject(Beam.BeamSprite(x=350,y=0,width=30,height=300,static='true',angle=0))
