...
def render(name,bg):
    ...
    lb.addObject(Beam.BeamSprite(x=240+40,y=25,width=60,height=30,static='true',angle=90))
    lb.addObject(Beam.BeamSprite(x=240-40,y=25,width=60,height=30,static='true',angle=90))
    ...
    lb.addObject(Friend.FriendSprite(x=240,y=125,width=128,height=128,denstity=0.02))
