...
def render(name,bg):
    ...
    lb.addObject(Enemy.EnemySprite(x=100,y=150,width=128,height=128,restitution=0.8,static='false'))
    lb.addObject(Star.StarSprite(x=100,y=150,width=32,height=32))
    
    revJoint = Joints.RevoluteJoint(body1='Star',body2='Enemy',motor_speed='50.0',torque='1000.0',
    ...
    lb.addObject(Beam.BeamSprite(x=0,y=0,width=300,height=300,static='true',angle=22))
    lb.addObject(Beam.BeamSprite(x=480,y=-100,width=300,height=300,static='true',angle=10))
    lb.addObject(Beam.BeamSprite(x=0,y=0,width=300,height=300,static='true',angle=66))
