...
def render(name,bg):
    ...
    lb.addObject(Bomb.BombSprite(x=100,y=25,width=50,height=50))
    lb.addObject(Bomb.BombSprite(x=160,y=25,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=160,y=75,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=160,y=125,width=50,height=50,density=5))
    lb.addObject(Enemy.EnemySprite(x=160,y=175,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=160,y=225,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=160,y=275,width=50,height=50))
    
    lb.addObject(Bomb.BombSprite(x=210,y=25,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=210,y=75,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=210,y=125,width=50,height=50,density=5))
    lb.addObject(Enemy.EnemySprite(x=210,y=175,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=210,y=225,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=210,y=275,width=50,height=50))
    
    lb.addObject(Friend.FriendSprite(x=260,y=25,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=260,y=75,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=260,y=125,width=50,height=50,density=5))
    lb.addObject(Enemy.EnemySprite(x=260,y=175,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=260,y=225,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=260,y=275,width=50,height=50))
