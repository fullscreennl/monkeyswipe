...
def render(name,bg):
    ...
    lb.addObject(Star.StarSprite(x=240,y=200,width=32,height=32))
    
    revJoint = Joints.RevoluteJoint(body1='Star',body2='star_holder',motor_speed='50.0',torque='1000.0',
    ...
    lb.addObject(SpikeyBuddy.SpikeyBuddySprite(x=450,y=200,width=40,height=40,density=10))
    ...
    lb.addObject(Beam.BeamSprite(x=362,y=-43,width=120,height=120,static='true',angle=-15))
    #lb.addObject(Beam.BeamSprite(x=296,y=15,width=60,height=60,static='true',angle=0))
    
    lb.addObject(Launcher.LauncherSprite(name='__launcher__1',x=240, y=-15, trigger_x=40, trigger_y=100))
