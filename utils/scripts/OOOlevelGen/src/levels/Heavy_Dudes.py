...
def render(name,bg):
    ...
    lb.addObject(Hero.HeroSprite(x=300,y=290))
    lb.addObject(Enemy.EnemySprite(x=100,y=100,width=200,height=200)) 
    lb.addObject(Friend.FriendSprite(x=300,y=100,width=200,height=200,density=100)) 
    lb.addObject(Star.StarSprite(x=200,y=10,width=20,height=20))
    lb.render()
