...
def render(name,bg):
    ...
    lb.addObject(Enemy.EnemySprite(x=240,y=100,width=50,height=50))
    lb.addObject(Enemy.EnemySprite(x=240,y=100,width=50,height=50))
    lb.addObject(Friend.FriendSprite(x=240-100,y=25,width=50,height=50,density=5))
    lb.addObject(Friend.FriendSprite(x=240+100,y=25,width=50,height=50,density=5))
    lb.addObject(Beam.BeamSprite(x=240,y=60,width=200,height=25,static='false',angle=0))
    lb.addObject(Star.StarSprite(x=240,y=10,width=20,height=20))
    lb.render()
