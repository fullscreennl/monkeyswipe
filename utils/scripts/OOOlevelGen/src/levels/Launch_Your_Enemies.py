...
def render(name,bg):
    ...
    lb.addObject(Star.StarSprite(x=240,y=70,width=32,height=32))
    ...
    lb.addObject(Launcher.LauncherSprite(name='__launcher__1',x=240, y=-15, trigger_x=40, trigger_y=290))
