...
def render(name,bg):
	...
	lb.addObject(Enemy.EnemySprite(x=tower_pos,y=25,width=50,height=50))
	lb.addObject(Enemy.EnemySprite(x=tower_pos,y=75,width=50,height=50))
	lb.addObject(Enemy.EnemySprite(x=tower_pos,y=125,width=50,height=50,density=5))
	lb.addObject(Enemy.EnemySprite(x=tower_pos,y=175,width=50,height=50))
	lb.addObject(Enemy.EnemySprite(x=tower_pos,y=225,width=50,height=50))
	lb.addObject(Enemy.EnemySprite(x=tower_pos,y=275,width=50,height=50))
	
	lb.addObject(Friend.FriendSprite(x=120,y=125,width=50,height=50,density=1,restitution=0.8))
	lb.addObject(Launcher.LauncherSprite(name='__launcher__1',x=120, y=10, trigger_x=20, trigger_y=300,power='#200'))
	
	lb.addObject(Beam.BeamSprite(x=79,y=75,width=30,height=150,static='true',angle=0))
	lb.addObject(Beam.BeamSprite(x=161,y=75,width=30,height=150,static='true',angle=0))
