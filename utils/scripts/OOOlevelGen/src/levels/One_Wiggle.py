...
def render(name,bg):
    ...
    lb.addObject(Friend.FriendSprite(x=240,y=125,width=128,height=128,density=1))
 
    distJoint = Joints.DistanceJoint(body1='base1',body2='Friend',damping='0.1',freq='0.6')   
    lb.addObject(distJoint)
    distJoint = Joints.DistanceJoint(body1='base2',body2='Friend',damping='0.1',freq='0.6')   
    lb.addObject(distJoint)
    ...
    distJoint = Joints.DistanceJoint(body1='base3',body2='Friend2',damping='0.1',freq='3')   
    lb.addObject(distJoint)
    distJoint = Joints.DistanceJoint(body1='base4',body2='Friend2',damping='0.1',freq='3')   
    lb.addObject(distJoint)
