...
for l in range(40):
    lb = LevelBuilder.LevelBuilder("level_"+str(l)+".plist", background="green_bg.png")
    ...
    lb.render()
    generated_levels += level_template%{'name':"leveldata_3/level_"+str(l+1), 'title':"level_"+str(l+1), 'par':60, 'tbl':60}
