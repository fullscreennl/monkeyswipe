...
def render(name,bg):
    ...
    lb.addObject(Enemy.EnemySprite(x=100,y=250,width=100,height=100)) 
    lb.addObject(Enemy.EnemySprite(x=100,y=100,width=200,height=200)) 
    lb.addObject(Enemy.EnemySprite(x=300,y=100,width=200,height=200,density=100)) 
    lb.addObject(Friend.FriendSprite(x=300,y=25,width=50,height=50,density=100)) 
    lb.addObject(Star.StarSprite(x=10,y=10,width=20,height=20))
