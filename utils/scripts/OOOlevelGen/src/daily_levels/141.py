...
def render(name,bg):
    ...
    lb.addObject(Enemy.EnemySprite(x=160,y=25,width=50,height=50,restitution='0.9'))
    lb.addObject(Enemy.EnemySprite(x=160,y=75,width=50,height=50,restitution='0.9'))
    lb.addObject(Star.StarSprite(x=160,y=125,width=20,height=20,density=5))
    lb.addObject(Enemy.EnemySprite(x=160,y=175,width=50,height=50,restitution='0.9'))
    lb.addObject(Enemy.EnemySprite(x=160,y=225,width=50,height=50,restitution='0.9'))
    lb.addObject(Friend.FriendSprite(x=160,y=275,width=50,height=50,restitution='0.9'))
