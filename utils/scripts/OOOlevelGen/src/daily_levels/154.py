...
def render(name,bg):
    ...
    #lb.addObject(Beam.BeamSprite(x=200,y=85,width=190,height=30,static='true',angle=110))
    ...
    enemyrad=80
    restitute=1
    lb.addObject(Enemy.EnemySprite(x=36+offsetx,y=20+offsety,width=enemyrad,height=enemyrad,density=1,restitution=restitute).setName('v1')) 
    lb.addObject(Enemy.EnemySprite(x=124+offsetx,y=20+offsety,width=enemyrad,height=enemyrad,density=1,restitution=restitute).setName('v2'))
    lb.addObject(Enemy.EnemySprite(x=152+offsetx,y=114+offsety,width=enemyrad,height=enemyrad,density=1,restitution=restitute).setName('v3')) 
    lb.addObject(Enemy.EnemySprite(x=8+offsetx,y=114+offsety,width=enemyrad,height=enemyrad,density=1,restitution=restitute).setName('v5')) 
    lb.addObject(Enemy.EnemySprite(x=80+offsetx,y=158+offsety,width=enemyrad,height=enemyrad,density=1,restitution=restitute).setName('v4')) 
    lb.addObject(Hero.HeroSprite(x=80+offsetx,y=80+offsety))
     
    lb.addObject(Star.StarSprite(x=480,y=16,width=32,height=32))
    ...
    distJoint = Joints.DistanceJoint(body1='v1',body2='Hero',damping=dampV,freq=freqV)   
    lb.addObject(distJoint)
    distJoint = Joints.DistanceJoint(body1='v2',body2='Hero',damping=dampV,freq=freqV)   
    lb.addObject(distJoint)
    distJoint = Joints.DistanceJoint(body1='v3',body2='Hero',damping=dampV,freq=freqV)   
    lb.addObject(distJoint)
    distJoint = Joints.DistanceJoint(body1='v4',body2='Hero',damping=dampV,freq=freqV)   
    lb.addObject(distJoint)
    distJoint = Joints.DistanceJoint(body1='v5',body2='Hero',damping=dampV,freq=freqV)   
    lb.addObject(distJoint)    
    ...
    lb.addObject(Contacts.Contact(body1='Hero',body2='v5',event_name='onLose'))	 
