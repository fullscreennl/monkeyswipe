...
def render(name,bg):
    ...
    lb.addObject(Beam.BeamSprite(x=190,y=250,width=460,height=20,static='true',angle=-10))
    lb.addObject(Beam.BeamSprite(x=290,y=100,width=460,height=20,static='true',angle=10))
    for e in range(20):
        lb.addObject(Enemy.EnemySprite(x=50+(e*10),y=300,width=32,height=32,restitution=0.9)) 
    #lb.addObject(Friend.FriendSprite(x=300,y=25,width=50,height=50,density=100)) 
    lb.addObject(Star.StarSprite(x=10,y=300,width=20,height=20))
